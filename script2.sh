...
COIN_DAEMON='/usr/local/bin/DUELIUMd'
COIN_CLI='/usr/local/bin/DUELIUM-cli'
COIN_REPO='https://github.com/DUELIUM-CORE/DUELIUM/releases/download/2.0.0.1/DL_Linux.tar.gz'
COIN_NAME='DUELIUM'
COIN_PORT=9888
